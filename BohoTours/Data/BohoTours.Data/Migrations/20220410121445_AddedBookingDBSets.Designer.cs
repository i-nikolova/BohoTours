...
namespace BohoTours.Data.Migrations
{
    ...
    [Migration("20220410121445_AddedBookingDBSets")]
    partial class AddedBookingDBSets
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BohoTours.Data.Models.VacationBooking", b =>
                {
                    b.HasOne("BohoTours.Data.Models.VacationPrice", "VacationPrice")
                        .WithMany("Bookings")
                        .HasForeignKey("VacationPriceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("VacationPrice");
                });
